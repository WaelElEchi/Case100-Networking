...
public class Server : CaseServer
{
    ...
    //✓
    public void SendParametersToClient(int id, int nbTeams, int sceneId, List<int> itemIds, int time)
    {
    ...
    //✓
    public void SendJoinResponseMessage(int id, bool canJoin, List<int> availableTeams)
    {
